    ...
    <div class="relative z-20 flex flex-col justify-center h-full px-3 mx-auto flex-center">
      <div class="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0">
        ...
        <div class="absolute right-1">
          ...
          <div
            v-show="dropdown"
            class="absolute top-2 w-32 py-2 mt-10 -ml-20 bg-white rounded-md shadow-xl dark:bg-gray-800"
          >
            <a
              v-for="item in dropdown_items"
              class="flex flex-row px-4 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 transform hover:bg-blue-500 hover:text-white"
              @click="$router.push(item.router); dropdown=false"
            >
              <span
